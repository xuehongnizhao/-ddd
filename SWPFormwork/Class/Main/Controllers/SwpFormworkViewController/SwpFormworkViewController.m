...
#import "SwpFormworkViewController.h"
...
@interface SwpFormworkViewController ()
...
@implementation SwpFormworkViewController
...
- (void)setNavigationBar {
    [self setNavigationBarTitle:@"模板" textColor:nil titleFontSize:nil];
}
